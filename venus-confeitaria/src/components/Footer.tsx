...
export default function Footer() {
  return (
    ...
    {/* Grid de 3 colunas harmônico e centralizado */}
  <div className="max-w-6xl mx-auto grid grid-cols-3 gap-8 items-start">
    ...
    <div className="flex flex-col items-center text-center gap-3">
      ...
      <div className="flex gap-6 text-pink-200 justify-center">
        ...
        <a 
          href="https://www.facebook.com/share/1BNEmnnjj5/" 
          target="_blank" 
          rel="noopener noreferrer"
          className="hover:text-white transition-colors"
        >
        ...
        <a 
          ...
          className="hover:text-white transition-colors"
        >
          <FontAwesomeIcon icon={faWhatsapp} className="text-xl cursor-pointer" />
        </a>
      </div>
    </div>
