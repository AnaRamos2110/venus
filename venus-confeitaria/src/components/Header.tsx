...
export default function Header() {
  ...
  // FIÇÃO DA BARRA DE PESQUISA (Guarda o texto e controla o Modal Mobile)
  const [termoBusca, setTermoBusca] = useState('');
  const [isSearchOpenMobile, setIsSearchOpenMobile] = useState(false);

  // Função que dispara a busca real quando aperta Enter
    ...
    <>
      <header className="bg-[#AA1F64] text-white p-4 sticky top-0 z-50 shadow-md font-['Montserrat']">
        <div className="max-w-7xl mx-auto flex justify-between items-center px-4 gap-4">
          ...
          {/* BARRA DE PESQUISA — DESKTOP (SÓ APARECE EM TELA GRANDE) */}
          ...
          {/* LUPA DE BUSCA — VERSÃO MOBILE (OPÇÃO 2) */}
          {/* Fica elegante no topo no lugar da barra gigante horrorosa */}
          <button 
